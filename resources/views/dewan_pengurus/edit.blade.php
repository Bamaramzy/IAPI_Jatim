<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 mt-6">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <form action="{{ route('dewan_pengurus.update', $dewan_pengurus->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $dewan_pengurus->nama) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="jabatan" id="jabatan"
                        value="{{ old('jabatan', $dewan_pengurus->jabatan) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 
                                  dark:bg-gray-900 dark:text-gray-200 focus:border-indigo-500 
                                  focus:ring-indigo-500 sm:text-sm"
                        required>
