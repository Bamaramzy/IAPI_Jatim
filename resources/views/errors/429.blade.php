...
<head>
    ...
    <title>429 - Terlalu Banyak Permintaan | IAPI Korda Jawa Timur</title>
            ...
            <div class="mx-auto w-32 h-32 flex items-center justify-center mb-6">
                <svg class="w-24 h-24 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        d="M12 9v2m0 4h.01M12 8a1 1 0 100 2 1 1 0 000-2zm0 7a1 1 0 100 2 1 1 0 000-2zm0-9a9 9 0 110 18 9 9 0 010-18z" />
                </svg>
            </div>

            <h1 class="text-6xl font-bold text-gray-700 mb-4">429</h1>
            <h2 class="text-xl font-semibold text-gray-600 mb-6">Terlalu Banyak Permintaan</h2>

            <p class="text-gray-500 mb-8 max-w-md mx-auto">
                Anda telah melampaui batas permintaan. Silakan tunggu beberapa saat sebelum mencoba lagi atau hubungi
