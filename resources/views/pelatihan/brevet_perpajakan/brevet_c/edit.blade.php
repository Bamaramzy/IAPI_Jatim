    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded p-6">
                <form action="{{ route('brevets_c.update', $brevet->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="judul" value="{{ old('judul', $brevet->judul) }}"
                            ...
                            placeholder="Masukkan judul brevet C" required>
                        @error('judul')
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Biarkan kosong jika tidak ingin mengubah brosur.
                        </p>
                        @error('brosur')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
