...
@section('content')
    <section class="max-w-5xl mx-auto px-6 py-12">
        <h1 class="text-3xl font-bold mb-10 text-center text-gray-800">
        ...
        <div class="space-y-4" x-data="{ openItem: null }">
            ...
            <div class="border rounded-lg overflow-hidden bg-white shadow-sm">
                <button @click="openItem === 1 ? openItem = null : openItem = 1"
                    ...
                    <span>Kode Etik Profesi Akuntan Publik 2019</span>
                ...
                <div x-show="openItem === 1" x-collapse x-transition
                    ...
                    <div class="pt-4 border-t">
                        <ul class="list-disc list-inside space-y-1">
                            <li><a href="https://drive.google.com/file/d/19NDTTXe6JllNohZ0Vtwd6SrdqaLOko9d/preview"
                                    target="_blank" class="text-blue-600 hover:underline">(PDF)</a></li>
                        </ul>
                    </div>
                </div>
            </div>
