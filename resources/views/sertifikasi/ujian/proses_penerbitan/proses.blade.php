...
@section('content')
    <section class="py-8 sm:py-12 px-4 bg-gray-100 min-h-screen">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 text-center mb-6 sm:mb-8">
                    ...
                    <div class="space-y-6">
                        <div x-show="tab === 'dasar'" class="space-y-6 p-4 sm:p-6">
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 sm:p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    <strong>Institut menerbitkan STLU-CPA</strong> bagi peserta yang memenuhi seluruh
                                    persyaratan
                                    berikut:
                                </p>
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    <li>Telah dinyatakan lulus pada setiap mata ujian tingkat dasar atau mendapat
                                        <i>waiver</i>.
                                    </li>
                                    ...
                                    <li>Menandatangani surat pernyataan kesanggupan pemenuhan kewajiban sebagai pemegang
                                        sertifikat
                                        CPA.</li>
                                    <li>Menandatangani surat pernyataan kesediaan mengikuti ketentuan Institut dalam hal
                                        pengajuan
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    Sertifikat ujian tingkat dasar berupa <strong>J-CPA</strong> diterbitkan untuk Peserta
                                    dengan
                                    pendidikan
                                ...
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    ...
                                    <li>Lulus atau mendapat <i>waiver</i> untuk mata ujian sebagaimana dimaksud Pasal 6 ayat
                                        (2)
                                    ...
                                    <li>Menandatangani surat pernyataan kesanggupan pemenuhan kewajiban sebagai pemegang
                                        ...
                                        dan
                                        Pakta Integritas.</li>
                                    <li>Menandatangani surat pernyataan kesediaan mengikuti ketentuan Institut terkait
                                        STL-UPAP
                                        dan
                                        izin Akuntan Publik.</li>
                                </ol>
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    Peserta yang telah lulus atau mendapatkan <i>waiver</i> untuk seluruh mata ujian tingkat
                                    dasar
                                    berhak
                                ...
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    <li>Menjadi anggota di Institut.</li>
                                    <li>Lulus 5 (lima) mata ujian tingkat dasar sesuai ketentuan. Sebagaimana dimaksud pada
                                        Pasal 6
                                        ayat (2)</li>
                                    <li>Menandatangani surat pernyataan kesanggupan mematuhi etika Dewan Sertifikasi.</li>
                                    <li>Melampirkan bukti ijazah atau surat keterangan lulus pendidikan bidang akuntansi
                                        (S-1,
                                        S-2,
                                        S-3, D-IV, atau PPAK).</li>
                                    <li>Melampirkan laporan magang atau pengalaman kerja minimal 3 bulan (di KAP atau
                                        entitas
                                        lain).
                                    </li>
                                    <li>Menandatangani surat pernyataan kesanggupan pemenuhan kewajiban sebagai pemegang
                            ...
                            <p class="text-gray-600 italic">
                                *J-CPA atau A-CPA merupakan sebutan resmi yang dapat digunakan pemegang sertifikat di
                                belakang
                                namanya.
                            </p>
                        </div>
                        <div x-show="tab === 'profesional'" class="space-y-8">
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    Institut menerbitkan <strong>STLU-CPA</strong> bagi peserta Ujian Profesi Akuntan Publik
                                    yang
                                    memenuhi syarat berikut:
                                </p>
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    <li>Lulus semua mata ujian tingkat dasar atau mendapat <i>waiver</i> (dibuktikan dengan
                                        surat
                                        keterangan lulus dari Dewan Sertifikasi).</li>
                                    <li>Lulus semua mata ujian tingkat profesional atau mendapat <i>waiver</i> (dibuktikan
                                        dengan
                                        surat keterangan lulus dari Dewan Sertifikasi).</li>
                                    <li>Menjadi anggota di Institut.</li>
                                    <li>Lulus pendidikan sesuai ketentuan di Institut atau telah terdaftar dalam register
                                        negara
                                        untuk akuntan.</li>
                                    <li>Menandatangani surat pernyataan kesanggupan pemenuhan kewajiban sebagai pemegang
                                        sertifikat
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    <strong>Untuk memenuhi ketentuan Anggaran Rumah Tangga Pasal 72 ayat (3)</strong>,
                                    Institut
                                    menerbitkan
                                ...
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    ...
                                    <li>Mendapat penilaian layak dari Dewan Sertifikasi terkait pengalaman kerja bidang
                                        akuntansi.
                                    </li>
                                    <li>Menandatangani pernyataan kesanggupan sebagai pemegang sertifikat CPA dan Pakta
                                        Integritas.
                                    </li>
                        ...
                        <div x-show="tab === 'audit'" class="space-y-8">
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    Institut menerbitkan <strong>STL-UPAP</strong> yang dapat digunakan untuk pemenuhan
                                    persyaratan
                                    perizinan
                                    Akuntan Publik bagi Peserta yang telah memenuhi seluruh persyaratan berikut:
                                </p>
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    <li>Lulus Ujian Profesi Akuntan Publik untuk seluruh mata ujian atau mendapat
                                        <i>waiver</i>
                                        yang dinyatakan dalam surat keterangan lulus untuk setiap mata ujian oleh Dewan
                                        Sertifikasi.
                                    </li>
                                    <li>Lulus pendidikan sesuai ketentuan di Institut atau telah terdaftar dalam register
                                        negara
                                        untuk akuntan.</li>
                                    <li>Menjadi Anggota di Institut.</li>
                                    <li>Lulus penilaian pengalaman kerja bidang akuntansi berupa audit atas laporan keuangan
                                        melalui
                                        KAP
                                ...
                                <p class="text-sm text-gray-600 mt-4">
                                    ...
                                    sesuai peraturan perundang-undangan, serta sebagai bukti pengalaman praktik bidang audit
                                    dan
                                    asurans
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <p class="text-gray-700 mb-4">
                                    Untuk memenuhi ketentuan <strong>PP-4</strong>, Institut menerbitkan <strong>sertifikat
                                        CPA</strong>
                                    dengan keterangan tambahan sebagai <strong>“CPA (License)”</strong> bagi Peserta yang
                                    telah
                                ...
                                <ol class="list-decimal ml-6 space-y-2 text-gray-700">
                                    ...
                                    <li>Memiliki pengalaman kerja bidang akuntansi berupa audit atas laporan keuangan di KAP
                                        minimal 3 (tiga) tahun dalam kurun waktu 5 (lima) tahun terakhir, termasuk
                                        pengalaman
