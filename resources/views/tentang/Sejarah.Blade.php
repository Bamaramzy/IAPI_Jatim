    ...
    <section class="max-w-5xl mx-auto px-6 py-12 mt-2 bg-white shadow-md rounded-lg text-justify">
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            Institut Akuntan Publik Indonesia (IAPI) atau <em>Indonesian Institute of Certified Public Accountants
                (IICPA)</em>,
            mempunyai latar belakang sejarah yang cukup panjang, dimulai dari didirikannya Ikatan Akuntan Indonesia di tahun
            1957
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            ...
            perekonomian,
            dunia usaha dan investasi baik asing maupun domestik, pasar modal serta pengaruh global.
        ...
        <div class="space-y-6 text-gray-700 leading-relaxed">
            <p>
                <strong>1957</strong> – Prof. R. Soemardjo Tjitrosidojo bersama empat lulusan pertama Fakultas Ekonomi
            ...
            <p>
                ...
                Hal ini dilakukan untuk merespons perkembangan pasar modal dan perbankan di Indonesia,
            ...
            <p>
                ...
                Perubahan organisasi ini bertujuan memenuhi persyaratan <em>International Federation of Accountants
                    (IFAC)</em>
            ...
            <p>
                ...
                Publik.
                Pengakuan ini memberi kewenangan kepada IAPI untuk melaksanakan Ujian Profesi Akuntan Publik,
                menyusun dan menetapkan Standar Profesional dan Etika Akuntan Publik, menyelenggarakan Program Pendidikan
                Berkelanjutan,
                sekaligus melaksanakan Reviu Mutu Akuntan Publik.
            </p>
        </div>
    </section>
@endsection
